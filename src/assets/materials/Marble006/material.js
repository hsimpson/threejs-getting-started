...
export function createMaterial() {
  ...
  const diffuseMap = loader.load('Marble006_4K_Color.jpg');
  diffuseMap.encoding = sRGBEncoding;
  material.map = diffuseMap;

  // roughness map
  const roughnessMap = loader.load('Marble006_4K_Roughness.jpg');
  material.roughnessMap = roughnessMap;

  // normal map
  const normalMap = loader.load('Marble006_4K_Normal.jpg');
